...
[Service]
Type=simple
ExecStart=/home/user/.local/share/fnm/node-versions/v24.13.0/installation/bin/node /path/to/pilot/dist/runner.js
Restart=always
RestartSec=10
User=luca
Environment=PATH=/home/user/.local/share/fnm/node-versions/v24.13.0/installation/bin:/usr/local/bin:/usr/bin
WorkingDirectory=/home/user/dev/punchlab
