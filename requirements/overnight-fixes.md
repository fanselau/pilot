...
- [ ] **Fix sessions.ts**: Replace ALL `claude` binary calls with `opencode` equivalents:
  ...
  - **IMPORTANT**: Test the actual opencode binary at `/home/user/.opencode/bin/opencode` to see what subcommands it supports
...
- [ ] **Fix package.json metadata**:
  ```json
  {
    ...
    "repository": {
      "type": "git",
      "url": "https://github.com/lucafanselau/pilot.git"
    },
...
## Technical Notes
- opencode binary is at `/home/user/.opencode/bin/opencode` — NOT in standard PATH
...
- PATH must include: `/home/user/.opencode/bin:/home/user/.local/bin:/home/user/.local/share/fnm/node-versions/v24.13.0/installation/bin`
