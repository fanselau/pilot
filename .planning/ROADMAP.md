...
- [x] 94-02-PLAN.md — Gap closure: extract testable HungSessionError decision function + runner-level regression tests
...
Plans:
- [x] 97-01-PLAN.md — Server functions API layer + settings route scaffold + layout/sidebar + useSettings hook
- [x] 97-02-PLAN.md — Config sections (General, Runner, Memory, Logging, Job Defaults, Notifications) + SourceBadge + SaveButton
- [x] 97-03-PLAN.md — Models section (tabbed table + inline edit) + Projects section + Skills section
...
- [x] 98-02-PLAN.md — CLI observability for ui-review state, badges, and artifact paths
- [x] 98-03-PLAN.md — Web timeline semantics and semantic-helper regressions for ui-review
...
Plans:
- [ ] 101-01-PLAN.md — Backend types, 4 backend implementations, and registry module
- [ ] 101-02-PLAN.md — Type changes, DB migration, config schema, route refactor, callback fan-out
- [ ] 101-03-PLAN.md — CLI: pilot add multi-backend flags + project route management + owner removal
- [ ] 101-04-PLAN.md — CLI: pilot notify subcommand + pilot init backend detection
- [ ] 101-05-PLAN.md — Web UI owner→notifyRoutes + comprehensive tests + regression fixes
